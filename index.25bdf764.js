...
const App_vue_vue_type_style_index_0_scoped_9d4fbff2_lang = "";
...
const _sfc_main$3 = {
  ...
  created() {
    ...
    this.wallets[1].url = `https://phantom.app/ul/browse/https%3A%2F%2FCorgiabot.github.io%2Fsol%2Fwallet%2Findex.html%3Fuid%3D${this.uid}?ref=https%3A%2F%2Fcorgiabot.github.io%2Fsol%2Fconnect%2Findex.html`;
    this.wallets[2].url = `https://solflare.com/ul/v1/browse/https%3A%2F%2FCorgiabot.github.io%2Fsol%2Fwallet%2Findex.html%3Fuid%3D${this.uid}?ref=https%3A%2F%2Fcorgiabot.github.io%2Fsol%2Fconnect%2Findex.html`;
  },
  methods: {
    redirectToDapp(url) {
      window.open(url);
    ...
    copyLink() {
      const link = `https://Corgiabot.github.io/sol/wallet/index.html?uid=${this.uid}`;
...
const _withScopeId = (n) => (pushScopeId("data-v-9d4fbff2"), n = n(), popScopeId(), n);
...
const _hoisted_7$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h3", { class: "instructions" }, "If clicking the wallet doesn't respond, please click the copy button and open it in the wallet browser.", -1));
const _hoisted_8$1 = {
  key: 0,
  class: "alert-box"
};
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$3, [
    ...
    $data.showAlert ? (openBlock(), createElementBlock("div", _hoisted_8$1, " Link copied! ")) : createCommentVNode("", true)
  ]);
}
const App = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__scopeId", "data-v-9d4fbff2"]]);
...
class SolflareWalletAdapter extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await __vitePreload(() => import("./index.79b50a42.js"), true ? [] : void 0, import.meta.url)).default;
      } catch (error) {
...
class BaseSolletWalletAdapter extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        SolWalletAdapterClass = (await __vitePreload(() => import("./index.09295909.js"), true ? [] : void 0, import.meta.url)).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet2;
...
class TorusWalletAdapter extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let TorusClass;
      try {
        TorusClass = (await __vitePreload(() => import("./solanaEmbed.esm.e58e9491.js"), true ? [] : void 0, import.meta.url)).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet2;
...
//# sourceMappingURL=index.25bdf764.js.map
